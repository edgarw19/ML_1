...
def tokenize_corpus(path, train=True):
  ...
  if train == True:
     ...
     # words is the words cont
     # docs is the tokens seen in each document
     # classes is the target
     # samples is the line of text
...
# docs is the words appearing in each sample, vocab is the words that are appearing
